...
class TaskDescriptorScreen extends StatefulWidget {
  const TaskDescriptorScreen({super.key});

  @override
  TaskDescriptorScreenState createState() => TaskDescriptorScreenState();
}

class TaskDescriptorScreenState extends State<TaskDescriptorScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //task decriptor list
          _buildTaskDescriptorList(currentUser, searchQuery, dropdownvalue, context),
...
Widget _buildTaskDescriptorList(User currentUser, String searchQuery, String dropdownvalue, BuildContext context) {
  return Expanded(
